...
def create_front_pages_with_tables():
    doc = docx.Document()
    ...
    doc.add_paragraph("Ankit Tiwari\nAnsh Goyel\nAniket Soni\nB.Tech. III Year\nDepartment of Computer Science & Engineering\nFaculty of Engineering\nMedicaps University, Indore")
    doc.add_page_break()
    ...
    toc_data = [
        ("Report Approval", "ii"), ("Declaration", "iii"), ("Certificate", "iv"),
        ("Acknowledgements", "v"), ("Abstract", "vi"), ("Table of Contents", "vii"),
        ("List of Figures", "viii"), ("List of Tables", "ix"), ("Abbreviations", "x"),
        ("Chapter 1: Introduction", "1"), ("  1.1 Introduction", "1"), ("  1.2 Literature Review", "2"),
        ("  1.3 Objectives", "3"), ("  1.4 Significance", "3"), ("  1.5 Research Design / Methodology", "4"),
        ("  1.6 Source of Data", "4"), ("  1.7 Chapter Scheme", "5"),
        ("Chapter 2: Requirements Specification", "6"), ("  2.1 User Characteristics", "6"), ("  2.2 Functional Requirements", "6"),
        ("  2.3 Dependencies", "7"), ("  2.4 Performance Requirements", "8"), ("  2.5 Hardware Requirements", "8"),
        ("  2.6 Constraints and Assumptions", "8"),
        ("Chapter 3: Design", "9"), ("  3.1 Algorithm", "9"), ("  3.2 Function Oriented Design", "10"),
        ("  3.3 System Design (DFD, Flow, Sequence, etc.)", "10"), ("  3.4 NoSQL Data Persistence Design", "12"),
        ("Chapter 4: Implementation, Testing, and Maintenance", "13"), ("  4.1 Languages, IDEs, Tools and Technologies", "13"),
        ("  4.2 Testing Techniques and Test Plans", "14"), ("  4.3 Installation Instructions", "15"), ("  4.4 End User Instructions", "15"),
        ("Chapter 5: Results and Discussions", "16"), ("  5.1 User Interface Representation", "16"), ("  5.2 Brief Description of Modules", "16"),
    ...
    fig_data = [
        ("3.1", "Data Flow Diagram – Level 0 (Context Diagram)", "10"),
        ("3.2", "Data Flow Diagram – Level 1", "10"),
        ("3.3", "Activity Diagram of AtmoSense AI", "11"),
        ("3.4", "System Flow Chart (Mock Data Fallback)", "11"),
        ("3.5", "Class Diagram (MERN Architecture)", "12"),
        ("3.6", "Entity-Relationship (ER) Diagram (MongoDB Schema)", "12"),
        ("3.7", "Sequence Diagram", "12"),
        ("5.1", "Dashboard Screenshot", "17"),
        ("5.2", "Health Prediction Output Screenshot", "17")
    ]
    ...
    tbl_data = [
        ("2.1", "Functional Requirements of AtmoSense AI", "6"),
        ("2.2", "Hardware & Software Requirements", "8"),
        ("4.1", "Test Cases for Core Operations", "14")
    ]
    ...
    hdr_cells[1].text = 'Title of Table'
    hdr_cells[2].text = 'Page No.'
    ...
    for item in abbr_data:
        row_cells = table.add_row().cells
        row_cells[0].text = item[0]
        row_cells[1].text = item[1]

    output_path = r'Report\AtmoSense_Front_Pages_With_Tables.docx'
    doc.save(output_path)
    print("Front pages with proper MS Word Tables generated successfully.")

if __name__ == '__main__':
    create_front_pages_with_tables()
